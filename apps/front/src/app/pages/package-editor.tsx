...
import { WizardStepper, StepperNavigation } from '../components/single/wizard-stepper';

const PackageEditorPage = () => {
  const { isStepSkipped, activeStep, stepMap, handleNext, handleBack, handleSkip, handleReset } =
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <WizardStepper isStepSkipped={isStepSkipped} activeStep={activeStep} stepMap={stepMap} />
        </Grid>
        ...
        <Grid container display="flex" flexDirection="column" justifyContent="center" alignItems="center">
          ...
          {activeStep === 2 ? <FileOptions /> : null}
          {activeStep === 3 ? <UploaderWizard /> : null}
        </Grid>
